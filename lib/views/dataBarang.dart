...
import 'package:point_of_sale/model/modelBarang.dart';
...
class _ListProdukState extends State<ListProduk> {
  ...
  Future<void> _lihatData() async {
    ...
    final response = await http.get(Uri.parse(BaseUrl.urlDataBarang), headers: {
    ...
    if (response.contentLength == 0) {
      ...
      data.forEach((api) {
        final ab = new ProdukModel(api['id_barang'], api['id_kategori'],
            api['nama_barang'], api['harga'], api['image']);
        list.add(ab);
      });
                    ...
                    itemBuilder: (context, i) {
                      ...
                      return Container(
                        ...
                        child: Row(
                          ...
                          children: <Widget>[
                            Image.network(
                                BaseUrl.paths + "" + x.image.toString(),
                                width: 100.0,
                                height: 120.0,
                                fit: BoxFit.cover),
                            SizedBox(width: 10.0),
